...
require_once dirname( __FILE__ ) . '/class-mo-saml-base-handler.php';
require_once dirname( __FILE__ ) . '/../classes/class-mo-saml-idp-metadata-reader.php';
require_once dirname( __FILE__ ) . '/../classes/class-mo-saml-login-widget.php';
require_once dirname( __FILE__ ) . '/../classes/class-mo-saml-customer.php';
require_once dirname( __FILE__ ) . '/../classes/class-mo-saml-logger.php';
require_once dirname( __FILE__ ) . '/../classes/mo-saml-settings-page.php';
require_once dirname( __FILE__ ) . '/../classes/class-mo-saml-utilities.php';
require_once dirname( __FILE__ ) . '/../classes/class-mo-saml-wp-config-editor.php';

/**
 * Main Form Handler class used to handle all the form submissions in the plugin.
 */
class Mo_SAML_Main_Handler {
